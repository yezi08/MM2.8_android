...
// start changes, 29/07/2015, change url of the "help"
//            var docsurl = 'https://docs.moodle.org/en/' + page;

            var docsurl = 'http://ice.xjtlu.edu.cn/course/view.php?id=521' + page;
...
.run(["$timeout", "$mmaModScormSync", "$mmApp", "$mmEvents", "mmCoreEventLogin", function($timeout, $mmaModScormSync, $mmApp, $mmEvents, mmCoreEventLogin) {
    var lastExecution = 0,
        executing = false;
    function syncScorms() {
        var now = new Date().getTime();
